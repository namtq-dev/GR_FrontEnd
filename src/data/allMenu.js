export const menu = [
  {
    name: 'Campus',
    icon: 'campus',
    description: 'A unique, exclusive space for college students on Aimer.',
  },
  {
    name: 'Events',
    icon: 'events',
  ...
  },
  {
    name: 'Pages',
    icon: 'pages',
    description: 'Discover and connect with businesses on Aimer.',
  },
  {
    name: 'Gaming Video',
    icon: 'gaming',
  ...
  },
  {
    ...
    icon: 'recent',
    description: 'See all the ads you interacted with on Aimer.',
  },
  {
    name: 'Memories',
    icon: 'memories',
    description: 'Browse your old photos, videos and posts on Aimer.',
  },
  {
    name: 'Saved',
    icon: 'saved',
